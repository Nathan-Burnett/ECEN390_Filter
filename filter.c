 -9.0907858587035801e-09, 0.0000000000000000e+00, 4.5453929293517900e-09,
0.0000000000000000e+00, -9.0907858587035803e-10}};
...
void initOutputQueues()
{
    ...
    for (uint32_t i=0; i<FILTER_IIR_FILTER_COUNT; i++)
    {
        ...
        queue_init(&(outputQueue[i]), FILTER_OUTPUT_QUEUE_SIZE, FILTER_OUTPUT_QUEUE_NAME);
        // and cycle through each possible location in the queues
        for (uint32_t j=FILTER_INITIALIZATIONS; j<FILTER_OUTPUT_QUEUE_SIZE; j++)
        {
            // fill those spots with zeros
...
double filter_firFilter()
{
    ...
    {
        // perform all the multiplications and sums needed to do perform the convolution
        y += queue_readElementAt(&xQueue,FILTER_FIR_COEF_COUNT-FILTER_AVOID_OFF_BY_ONE-i) * fir_coeffs[i]; // iteratively adds the (b * input) products.
    }
...
double filter_iirFilter(uint16_t filterNumber)
{
    ...
    for (uint16_t i = FILTER_INITIALIZATIONS; i<FILTER_Y_QUEUE_SIZE; i++)
    {
        // make a summation of all of the values multiplied by the iir b coefficients
        y_sum += queue_readElementAt(&yQueue,
                queue_elementCount(&yQueue)-i-FILTER_AVOID_OFF_BY_ONE) * irr_b_coeffs[filterNumber][i];
    }
    //cycle through all of the z queue
    for (uint16_t i = FILTER_INITIALIZATIONS; i<FILTER_Z_QUEUE_SIZE; i++)
    {
        // do the summation of all the values multiplied by the iir a coefficients
        z_sum += queue_readElementAt(&(zQueue[filterNumber]), queue_elementCount(&(zQueue[filterNumber]))-i-FILTER_AVOID_OFF_BY_ONE) * irr_a_coeffs[filterNumber][i+FILTER_AVOID_OFF_BY_ONE];
    }
...
double filter_computePower(uint16_t filterNumber, bool forceComputeFromScratch, bool debugPrint){
    ...
    // decide to compute the power values from scratch or use previously computed values
    if(forceComputeFromScratch)
    {
        // computing from scratch, cycle through all of the output queue
        for(uint32_t i = FILTER_INITIALIZATIONS; i<FILTER_OUTPUT_QUEUE_SIZE; i++)
        {
            // create a value to save another function call in squaring the values for the power
            double value = queue_readElementAt(&(outputQueue[filterNumber]), i);
            // add up the summed and squared values for the power
            power += value*value;
        }
        // save the found power as the prev_power, which will also double as the current power
        prev_power[filterNumber] = power;
        // keep track of the oldest value in the filter so next time we don't have to do the whole computation again
        oldest_value[filterNumber] = queue_readElementAt(&(outputQueue[filterNumber]),
                FILTER_OLDEST_VALUE_INDEX);
    }
    else
    {
        // don't compute from scratch, just find the newest value in the queue
        double newest_value = queue_readElementAt(&(outputQueue[filterNumber]),
                FILTER_OUTPUT_QUEUE_SIZE - FILTER_AVOID_OFF_BY_ONE);
        // calculate power from the previous value minus the contribution of the old->oldest value and adding the newest value contribution
        power = prev_power[filterNumber] -
        (oldest_value[filterNumber]*oldest_value[filterNumber]) + (newest_value*newest_value);
        // reset the previous/current power to the most recently calculated
        prev_power[filterNumber] = power;
        // reset the oldest value to the oldest value in the queue
        oldest_value[filterNumber] = queue_readElementAt(&(outputQueue[filterNumber]),FILTER_OLDEST_VALUE_INDEX);
    }
...
double filter_getCurrentPowerValue(uint16_t filterNumber){
    // returns the current power value is just the last one that we found for that filter
...
void filter_getNormalizedPowerValues(double normalizedArray[], uint16_t* indexOfMaxValue){
    ...
    for (uint16_t i = FILTER_INITIALIZATIONS; i<FILTER_IIR_FILTER_COUNT; i++)
    {
        // place normalized values based on the max power value found in the powerValues array used in the function
